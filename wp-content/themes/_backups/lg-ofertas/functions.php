...
function lg_ofertas_scripts() {
	...
	wp_enqueue_script( 'animate-enhanced', get_template_directory_uri() . '/js/jquery.animate-enhanced.min.js' );
	wp_enqueue_script( 'superslides-js', get_template_directory_uri() . '/js/jquery.superslides.min.js' );
